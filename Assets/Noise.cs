...
namespace Simplex
{
    ...
    public class Noise
    {
        ...
        internal static float Generate(Vector2 v) { return Simplex.Noise.Generate(v.x, v.y); }
        internal static float Generate(Vector3 v) { return Simplex.Noise.Generate(v.x, v.y, v.z); }
